      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
            ...
            {/* Title */}
            <h2 className="text-[#0c1d1a] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-8 pt-5">
            ...
            <div className="flex justify-center">
              <div className="flex max-w-[480px] w-full flex-wrap items-end gap-4 px-4 py-3">
                <label className="flex flex-col min-w-40 flex-1">
                  <p className="text-[#0c1d1a] text-base font-medium leading-normal pb-2">Email address</p>
                  <div className="relative">
                    ...
                    <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                      <svg className="w-5 h-5 text-[#45a193]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
