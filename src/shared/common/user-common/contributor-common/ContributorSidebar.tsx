...
export default function ContributorSidebar({ activeItem = 'dashboard' }: SidebarProps) {
    ...
    const menuItems = [
        { id: 'dashboard', label: 'Dashboard', icon: <Home size={20} />, href: '/contributor-dashboard' },
        { id: 'tasks', label: 'Tasks', icon: <Clipboard size={20} />, href: '/contributor-tasks' },
        { id: 'meetings', label: 'Meetings', icon: <Calendar size={20} />, href: '/contributor-meetings' },
        { id: 'chat', label: 'Chat', icon: <MessageSquare size={20} />, href: '/contributor-chat' },
    ];
