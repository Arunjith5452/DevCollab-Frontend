...
import { Calendar, Clipboard ,FileText, Home, Megaphone, User, Users } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 'tasks', label: 'Tasks', icon: <Clipboard size={20} />, href: '/dashboard/tasks' },
  ...
  { id: 'announcements', label: 'Announcements', icon: <Megaphone size={20} />, href: '/dashboard/announcements' },
    ...
    return (
        <aside className="w-64 bg-white border-r border-[#e6f4f2] flex flex-col min-h-screen">
            ...
            {/* Notifications */}
            <div className="px-6 py-4 border-t border-[#e6f4f2]">
